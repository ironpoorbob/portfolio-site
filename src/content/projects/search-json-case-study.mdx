...
images:
  - src: "/case-studies/search-case-study-card.png"
    alt: "Search results card with a dynamic credit card product upsell"
    caption: "Search results card with a dynamic credit card product upsell."
  - src: "/case-studies/search-case-study-cta-banner.png"
    alt: "Product CTA banner component injected through the rules engine."
    caption: "Product CTA banner component injected through the rules engine."
  - src: "/case-studies/search-case-study-faq.png"
    alt: "FAQ content rendered when matching search term is detected."
    caption: "FAQ content rendered when matching search term is detected."
  - src: "/case-studies/search-case-study-locations.png"
    alt: "Location CTA banner inserted to bring users to branch locations portal"
    caption: "Location CTA banner inserted to bring users to branch locations portal."
