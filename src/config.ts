...
export const siteConfig = {
   ...
   */
  title: getEnv('SITE_TITLE', 'Web Devlopment Portfolio'),
   ...
   */
  description: getEnv('SITE_DESCRIPTION', 'Engineering leader focused on turning complex technical problems into maintainable solutions and high-efficiency workflows.'),
  ...
  author: {
    /** Full name */
    name: getEnv('SITE_AUTHOR_NAME', 'Bob Conlon'),
    
    /** Professional title or role */
    title: getEnv('SITE_AUTHOR_TITLE', 'Lead Software Developer'),
    
    /** Short biography or professional summary */
    bio: getEnv('SITE_AUTHOR_BIO', 'Engineering leader focused on turning complex technical problems into maintainable solutions and high-efficiency workflows.'),
    
    /** Contact email address */
    email: getEnv('SITE_AUTHOR_EMAIL', 'ipbconlon@gmail.com'),
