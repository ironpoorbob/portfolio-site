...
export default defineConfig({
  ...
  env: {
    schema: {
      ...
      // Author information
      SITE_AUTHOR_NAME: envField.string({ context: 'client', access: 'public', default: 'Bob Conlon' }),
      SITE_AUTHOR_TITLE: envField.string({ context: 'client', access: 'public', default: 'Lead Software Developer' }),
      SITE_AUTHOR_BIO: envField.string({ context: 'client', access: 'public', default: 'Engineering leader focused on turning complex technical problems into maintainable solutions and high-efficiency workflows.' }),
      SITE_AUTHOR_EMAIL: envField.string({ context: 'client', access: 'public', default: 'ipbconlon@gmail.com' }),
